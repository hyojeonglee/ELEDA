...
{
    return create_index(vid, ntype, property, key_desc, t_cc_kvl, stid);
}
    ...
    )
{
  ...
  //  _create_index(vid, ntype, property, key_desc, cc, stid);
	//cout << " 7 " << endl;
    return RCOK;
}
...
//	cout << " 4 " << endl;
    ...
    sinfo_s sinfo(stid.store, t_index, 100/*unused*/, 
                  ...
                  count, kcomp);
#endif
	sinfo_s sinfo(stid.store, t_index, 100, ntype, cc, root.page ,count, kcomp);
//	cout << " 5 " << endl;
    W_DO( dir->insert(stid, sinfo));
//	cout << " 6 " << endl;
    return RCOK;
