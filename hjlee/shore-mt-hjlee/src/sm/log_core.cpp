...
// TODO: Replace with ELEDA's API
// long eleda_reserve_lsn (size_t len);
//	- using FAA, return lsn (long type).
...
long eleda_reserve_lsn(size_t len) {
	...
	// Get lsn(position) using fetch-add operation.
	// 기존에 lsn 처리하는 루틴: _copy_to_buffer --> insert_info struct 
